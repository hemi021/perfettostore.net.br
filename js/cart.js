function renderizarCarrinho() {
    ...
    if (!lista) return; // Segurança caso o ID não exista
    ...
    if (carrinho.length === 0) {
        lista.innerHTML = `
            <div style="text-align:center; padding: 40px;">
                ...
                <a href="index.html" class="btn-continue" style="margin-top:20px; color: #957DAD; font-weight: bold; text-decoration: underline; display: block;">
                    VOLTAR PARA A LOJA
                </a>
            </div>
        `;
